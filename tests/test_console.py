#!/usr/bin/python3
"""defines console.py's unittests.
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unit tests to verify the HBNB command interpreter's exit."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Tests for unit creation are generated by the HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Testing unittests are displayed via the HBNB command interpreter."""
